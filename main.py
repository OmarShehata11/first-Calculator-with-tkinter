...
if __name__ == '__main__':
    ...
    input_frame = Frame(root, width=490, height=40, bd=0, highlightbackground="black", highlightcolor="black",
                        highlightthickness=4)
    input_frame.grid(row=1, columnspan=4)

    screen = Entry(root, width=37, bd=0, highlightbackground="black", borderwidth=1, font=('arial', 18, 'bold'))
